...
for dpi, def_prob in enumerate(def_prob_range):
    ...
    # load data
    mvpa_data_dict_fname = 'new-mvpa-schema-%.1f.pkl' % (def_prob)
    ...
    # df_grcl = mvpa_data_dict['df_g']
    df_grcl = mvpa_data_dict['df_grcl']
    # df_genc = mvpa_data_dict['df_genc']

    mvpa_data_dict_fname = 'mvpa-schema-%.1f.pkl' % (def_prob)
    mvpa_data_dict = pickle_load_dict(
        os.path.join('temp', mvpa_data_dict_fname))
    df_grcl_old = mvpa_data_dict['df_g']
